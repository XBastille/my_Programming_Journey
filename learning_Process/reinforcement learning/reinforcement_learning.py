import time, gym, tensorflow as tf, utils, PIL.Image, numpy
...
MEMORY_SIZE=100_100   # size of memory buffer
...
'''for i in range(num_episodes):
    ...
    for t in range(max_num_timesteps):
        ...
        if update := utils.check_update_conditions(
...
model=load_model("lunar_lander_model.h5")
q_network=model
